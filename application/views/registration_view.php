<!-- application/views/registration_view.php -->
...
<body>
	...
	<div class="header">
		<div class="logo text-center"><img src="<?= base_url() ?>/assets/img/1.png" alt="Logo SMKN 4 Malang" height="100"></div>

	</div>
	<div align="center">
		<h5 class="heading">Register SIE</h5>
	</div>
